...
std::optional<Error> SymbolLayer::setPropertyInternal(const std::string& name, const Convertible& value) {
    ...
    if (property == SymbolProperty::IconPadding || property == SymbolProperty::SymbolSpacing ||
        property == SymbolProperty::TextLineHeight || property == SymbolProperty::TextMaxAngle ||
        property == SymbolProperty::TextPadding) {
        Error error;
